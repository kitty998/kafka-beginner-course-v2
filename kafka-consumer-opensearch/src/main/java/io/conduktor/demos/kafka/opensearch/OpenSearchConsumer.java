...
//        String connString = "https://c9p5mwld41:45zeygn9hy@kafka-course-2322630105.eu-west-1.bonsaisearch.net:443";
        ...
        public static void main(String[] args) throws IOException {
            ...
            // create and index on OpenSearch if it does not exist
            ...
            try {
                ...
                while (true) {
                    ...
                    int recordCourt = records.count();
                    log.info("Received " + recordCourt + " record(s)");
                    ...
                    for (ConsumerRecord<String, String> record : records){
                        ...
                        try{
                            // strategy 2: extract the id from the JSON meta
                        ...
                        // commit offsets ONLY after the batch has been successfully processed

                        consumer.commitSync(); // can do async
